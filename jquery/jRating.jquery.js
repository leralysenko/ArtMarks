			...
			$(this).bind({
				...
				click : function(e){
					...
					/** ONLY FOR THE DEMO, YOU CAN REMOVE THIS CODE **/
						$('.datasSent p').html('<strong>ID контейнера : </strong>'+idBox+'<br /><strong>Оценка : </strong>'+rate+'<br /><strong>Действие :</strong> оценивание');
						$('.serverResponse p').html('<strong>Загрузка...</strong>');
